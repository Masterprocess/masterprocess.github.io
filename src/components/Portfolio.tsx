...
export const Portfolio = forwardRef<HTMLElement>((props, ref) => {
  ...
  return (
    <section ref={ref} className="py-32 bg-gradient-to-b from-black via-gray-950 to-black film-grain relative overflow-hidden">
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8" ref={sectionRef}>
        ...
        <div className="space-y-48">
          {projects.map((project, index) => {
            ...
            return (
              <div
                key={project.id}
                className={`group relative ${isEven ? 'lg:grid lg:grid-cols-12 lg:gap-16' : 'lg:grid lg:grid-cols-12 lg:gap-16'} items-center`}
              ...
              >
                    ...
                    <div className="aspect-[16/10] overflow-hidden dramatic-shadow group-hover:scale-105 transition-all duration-1000">
                      ...
                      <div className="absolute inset-0 overflow-hidden">
                        <div
                          ...
                          style={{ animation: isActive ? 'slideInUp 2s ease-in-out infinite' : 'none', transform: 'translateX(-100%)' }}
                        />
                      </div>
                    </div>
                ...
                <div className={`lg:col-span-5 ${isEven ? 'lg:col-start-8' : 'lg:col-start-1'} space-y-8`}>
                  ...
                  <div>
                    <h3 className="text-4xl md:text-5xl lg:text-6xl text-white leading-tight tracking-tight mb-2">{project.title}</h3>
        ...
        <div className="text-center mt-32">
          ...
          <p className="text-gray-400 mt-4 text-sm">50+ projects • 15+ awards • 8+ years experience</p>
        </div>
      </div>
    </section>
  );
