      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-24">
        ...
        <div className="mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Creative director with a passion for crafting meaningful digital experiences 
            that bridge the gap between design and human connection.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
                <p>
                  With over 8 years of experience in the design industry, I've had the 
                  privilege of working with startups, Fortune 500 companies, and everything 
                  in between. My approach combines strategic thinking with creative execution 
                  to deliver solutions that not only look exceptional but also drive real results.
                </p>
                <p>
                  I believe great design happens at the intersection of user needs, business 
                  goals, and technological possibilities. Whether it's crafting a brand identity 
                  from scratch or optimizing a complex user interface, I focus on creating 
        ...
        <div className="bg-gray-900 p-12 noir-border">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <blockquote className="text-lg md:text-xl text-gray-300 leading-relaxed italic">
              ...
              even think about it. It's the perfect marriage of form and function, where 
              every element has a purpose, and every purpose is beautifully expressed. 
              In a world full of noise, I create clarity."
            </blockquote>
          </div>
        </div>
      </div>
