      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-24">
        ...
        <div className="mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            I'm always interested in discussing new projects, creative collaborations, 
            or opportunities to push the boundaries of design.
          </p>
        </div>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-gray-900 p-8 noir-border">
              ...
              <p className="text-gray-300 mb-4">
                I'm currently accepting new projects for Q2 2024. Whether you need 
                a complete brand overhaul or focused design consulting, let's discuss 
            ...
            <div className="bg-gray-900 p-8 noir-border">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-black border-gray-700 text-white placeholder:text-gray-500 focus:border-red-500"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="project" className="block text-white mb-2 text-sm">
                      Project Type
                    </label>
                    <Input
                      id="project"
