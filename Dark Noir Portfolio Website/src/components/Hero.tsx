          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative parallax-element" style={{ transform: 'translateZ(50px)' }}>
              ...
              <div className="relative">
                ...
                {/* Scan Line Effect */}
                <div className="absolute inset-0 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-red-500 to-transparent opacity-20 h-2 animate-pulse" style={{
